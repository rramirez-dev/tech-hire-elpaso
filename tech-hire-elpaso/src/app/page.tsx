    ...
    <div>
      ...
      <section className="max-screen-width px-4 py-10 flex flex-col md:flex-row gap-12">
        ...
        <div className="md:w-1/2 mb-8 md:mb-0 space-y-8">
          <h1 className="lg:text-6xl md:text-5xl text-4xl font-bold text-heading-text leading-tight dark:text-white">
            Join the commuity of IT Professionals in{" "}
            <br className="lg:block hidden" />
            El Paso, Texas
          </h1>
          <p className="text-primary-text text-lg leading-relaxed max-w-xl dark:text-white">
          ...
          <div className="flex flex-row md:flex-col gap-2">
            ...
            <div className="flex flex-col md:flex-row gap-4">
              <div className="flex flex-col bg-gray-700 text-white font-bold text-center justify-center p-2 dark:bg-gray-800">
                <div className="dark:text-white">20</div>
                <div className="dark:text-white">September</div>
              </div>
            ...
            <div className="flex flex-col md:flex-row gap-4">
              ...
              <div className="flex flex-col">
                ...
                <div className="font-bold text-gray- dark:text-gray-500">
